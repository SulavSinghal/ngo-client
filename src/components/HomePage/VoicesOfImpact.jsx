...
const TestimonialCard = ({ testimonial }) => (
  <motion.div
    className="bg-white/15 backdrop-blur-sm p-8 rounded-2xl shadow-lg flex flex-col h-full text-left"
    initial={{ opacity: 0, scale: 0.85, y: 40 }}
    whileInView={{ opacity: 1, scale: 1, y: 0 }}
    viewport={{ once: false}}
    transition={{ duration: 0.6, ease: "easeOut" }}
    whileHover={{ scale: 1.05, boxShadow: "0 12px 24px rgba(26, 42, 108, 0.3)" }}
  >
...
const VoicesOfImpact = () => {
  ...
  return (
    <motion.section
      className="bg-[#1A2A6C] py-20 px-4 font-sans"
    ...
    >
      <div className="container mx-auto text-center">
        <motion.h2
          className="text-4xl md:text-4xl font-bold text-white mb-4 font-serif"
        ...
        <motion.p
          className="text-lg text-[#D4AF37CC] max-w-2xl mx-auto mb-12 font-display"
