...
function ActivitiesFilterBar({ categories, selectedCategory, setSelectedCategory }) {
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-16 mt-8">
      {/* LHS: Static Text */}
      <div className="mb-3 md:mb-0">
        <span className=" text-[#1F316C] text-lg"  style={{ fontFamily: "'Merriweather', serif" }}>Filter Activities</span>
      </div>
      {/* RHS: Pill Buttons */}
      <div className="flex gap-3 flex-wrap">
        {["All Activities", ...categories].map((cat) => (
          <button
            key={cat}
