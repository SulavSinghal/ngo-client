        ...
        {members.map(member => (
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between px-5 py-6 text-left">
              <h3
                className="text-[20px] md:text-[19px] font-bold text-[#25326b] mb-1 leading-tight"
                style={{ fontFamily: "'Merriweather', serif" }}
              >
                {member.name}
              </h3>
              <div
                className="text-[#1F817C] text-[15.5px]  mb-[4px]"
                style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}
              >
                {member.title}
              </div>
              <p
                className="text-[#383C52] text-[15px] font-normal mb-3"
                style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}
              >
                {member.bio}
              </p>
...
export default InchargeMembers;
